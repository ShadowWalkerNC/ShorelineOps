...
exports.DietaryNutritionalEngine = exports.INGREDIENT_NUTRIENT_LIBRARY = exports.CLINICAL_DIET_RULES = void 0;
const units_1 = require("./units");
exports.CLINICAL_DIET_RULES = {
    'Regular': {
...
exports.INGREDIENT_NUTRIENT_LIBRARY = {
    'chicken breast': {
...
class DietaryNutritionalEngine {
    /**
     ...
     */
    static lookupNutrientProfile(itemName) {
        const lower = itemName.toLowerCase().trim();
        for (const [key, profile] of Object.entries(exports.INGREDIENT_NUTRIENT_LIBRARY)) {
     ...
     */
    static calculateRecipeNutrition(ingredients, baseServings) {
     ...
     */
    static validateMealForResident(resident, mealItems) {
        ...
        const rule = exports.CLINICAL_DIET_RULES[resident.dietType];
        if (rule) {
...
exports.DietaryNutritionalEngine = DietaryNutritionalEngine;
