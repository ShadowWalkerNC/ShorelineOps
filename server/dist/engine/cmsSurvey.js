...
exports.CmsDietarySurveyEngine = void 0;
class CmsDietarySurveyEngine {
    /**
     * Generate complete CMS-2567 dietary inspection audit pack
     */
    static generateSurveyAuditPack(input) {
        const { facilityName = 'Shoreline Healthcare Community', residents, temperatureLogs = [], cycleMenuWeeksCount = 4, mealServiceTimes = {
     ...
     */
    static generateDigitalSurveyBinderMarkdown(pack) {
...
exports.CmsDietarySurveyEngine = CmsDietarySurveyEngine;
