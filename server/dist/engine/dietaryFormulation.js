...
exports.DeterministicDietaryEngine = void 0;
const units_1 = require("./units");
class DeterministicDietaryEngine {
    /**
     * Pre-built clinical ingredient substitution rules
     */
    static SUBSTITUTION_RULES = [
     ...
     */
    static findSubstitutions(ingredients, constraint) {
        const results = [];
     ...
     */
    static computeIddsiFormulation(baseFoodName, foodCategory, cookedWeightGrams, targetLevel = 4) {
     ...
     */
    static auditCycleMenu(days) {
        const proteinRotationIssues = [];
        const colorWarnings = [];
        const recommendations = [];
        let nonCompliantTimingDays = [];
     ...
     */
    static splitCensusProductionDemand(menuItemName, basePortionOz, census) {
...
exports.DeterministicDietaryEngine = DeterministicDietaryEngine;
