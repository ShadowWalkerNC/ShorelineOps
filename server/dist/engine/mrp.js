...
exports.MrpDemandForecastEngine = void 0;
const units_1 = require("./units");
class MrpDemandForecastEngine {
    /**
     * Explode scheduled cycle meals into consolidated raw ingredient demands (BOM explosion)
     */
    static explodeBillOfMaterials(scheduledMeals) {
        const demandMap = {};
     ...
     */
    static evaluateMultiDistributorLowestCost(ingredientName, netDemandGrams, offers, targetServiceDay = 'Monday') {
        ...
        const evaluatedOffers = offers.map(offer => {
            ...
            const hasDirectDelivery = offer.deliveryDays.some(d => d.toLowerCase() === targetServiceDay.toLowerCase());
     ...
     */
    static calculateMaterialRequirements(explodedDemands, inventoryStock) {
     ...
     */
    static calculateEdibleVsPurchasedCost(asPurchasedUnitCost, yieldPercentage = 100) {
...
exports.MrpDemandForecastEngine = MrpDemandForecastEngine;
