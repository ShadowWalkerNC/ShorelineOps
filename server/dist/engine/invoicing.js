...
exports.ThreeWayInvoiceMatchingEngine = void 0;
class ThreeWayInvoiceMatchingEngine {
    /**
    ...
    static evaluateThreeWayMatch(input) {
        ...
        if (totalCreditDisputed > 0) {
            ...
            if (hasPriceVar && hasQtyVar)
                overallStatus = 'DISPUTED';
            else if (hasPriceVar)
                overallStatus = 'PRICE_VARIANCE';
            else
                overallStatus = 'QUANTITY_SHORT';
        }
        let creditMemo;
        if (totalCreditDisputed > 0) {
...
exports.ThreeWayInvoiceMatchingEngine = ThreeWayInvoiceMatchingEngine;
