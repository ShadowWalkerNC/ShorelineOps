...
exports.StripeBillingEngine = void 0;
class StripeBillingEngine {
    static BASE_RATE_PER_BED = 2.00; // $2.00 / bed / month
    static ENTERPRISE_VOLUME_DISCOUNT_THRESHOLD = 150; // beds
    /**
     * Calculates monthly SaaS subscription based on facility scale.
     */
    static calculateMonthlyFee(licensedBeds, activeCensus) {
     ...
     */
    static handleStripeWebhookEvent(event) {
...
exports.StripeBillingEngine = StripeBillingEngine;
