...
exports.DennisConnector = void 0;
class DennisConnector {
    vendorCode = 'dennis';
    vendorName = 'Dennis Food Service';
    catalogPortalUrl = 'https://dennisfoodservice.pepr.app/';
    homeUrl = 'https://dennisfoodservice.com/';
    orderingPlatform = 'Pepper (pepr.app)';
    supportPhone = '1-800-439-2727';
    /**
     ...
     */
    async importOrderGuide(fileContent) {
...
exports.DennisConnector = DennisConnector;
