...
exports.UsFoodsConnector = exports.SyscoConnector = void 0;
class SyscoConnector {
    vendorCode = 'sysco';
    ...
    async getCustomerPricing(accountId) {
        return [
...
exports.SyscoConnector = SyscoConnector;
class UsFoodsConnector {
    vendorCode = 'usfoods';
    vendorName = 'US Foods';
    async getCatalog() {
        return [
...
exports.UsFoodsConnector = UsFoodsConnector;
